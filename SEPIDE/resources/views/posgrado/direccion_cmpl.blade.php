...
@section('content')
    <section id="content">
        <div class="content">
            ...
            @endif
            <div class="row">
                <h1 class="text-center">Dirección de tesis programa CMP+L</h1>
            </div>
            <div class="row text-left">
                <a href="{{url('/direccion_cmpl/agregar')}}" class="btn btn-success">Agregar dirección</a>
                &nbsp;
                <br />
            </div>
            ...
            <table class="table-striped">
                <tr>
                    ...
                    <th class="col-xs-2 col-sm-2 col-md-2 col-lg-2">Fecha límite para obtener grado</th>
                        ...
                        <td class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{url('direccion_cmpl/'.$direccion->id)}}">Detalles</a></li>
                                    <li><a href="{{url('direccion_cmpl/editar/'.$direccion->id)}}">Editar</a></li>
                                    <li role="separator" class="divider"></li>
                                    <li class="alert-danger"><a href="{{url('direccion_cmpl/eliminar/'.$direccion->id)}}"><span class="glyphicon glyphicon-remove red" aria-hidden="true"></span>Eliminar</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
