...
<section id="content">
        <div class="content">
            ...
                     <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                         <input type="text" name="programa" class="form-control disabled" placeholder="Programa">
                     </div>
                 </div>
            ...
                     <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <input type="text" name="lgac" class="form-control disabled" placeholder="Línea general de aplicación de conocimiento">
                     </div>
                 </div>
